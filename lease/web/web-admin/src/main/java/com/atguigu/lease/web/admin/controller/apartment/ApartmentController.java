...
public class ApartmentController {
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current, @RequestParam long size, ApartmentQueryVo queryVo) {
        IPage<ApartmentItemVo> apartmentInfoPage = new Page<>(current,size);
        IPage<ApartmentItemVo> page = apartmentInfoService.ApartmentQueryPage(apartmentInfoPage,queryVo );
